...
router.post("/google/exchange-token", googleAuth_controller_1.exchangeGoogleToken);
// This endpoint still requires authentication to associate tokens with user
router.post("/google/connect", auth_1.authenticate, googleAuth_controller_1.connectGoogleAccount);
router.post("/google/disconnect", auth_1.authenticate, googleAuth_controller_1.disconnectGoogleAccount);
